...
## ----umap-viz-price, fig.cap="UMAP projection colored by Sale Price"----------
...
## ----umap-viz-neighborhood, fig.cap="UMAP projection colored by Neighborhood"----
...
## ----param-comparison, fig.height=8, fig.cap="Effect of n_neighbors on UMAP embedding"----
set.seed(123)
...
## ----supervised-umap, fig.cap="Supervised UMAP uses Sale Price to guide the projection"----
set.seed(123)
...
## ----embedmit-integration, eval=FALSE-----------------------------------------
# library(embedmit)
# library(recipes)
# 
