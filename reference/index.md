...
- [`lvish()`](https://rmsharp.github.io/uwotlite/reference/lvish.md) :
  Dimensionality Reduction with a LargeVis-like method
- [`optimize_graph_layout()`](https://rmsharp.github.io/uwotlite/reference/optimize_graph_layout.md)
...
- [`similarity_graph()`](https://rmsharp.github.io/uwotlite/reference/similarity_graph.md)
  : Similarity Graph
- [`simplicial_set_intersect()`](https://rmsharp.github.io/uwotlite/reference/simplicial_set_intersect.md)
  : Merge Similarity Graph by Simplicial Set Intersection
- [`simplicial_set_union()`](https://rmsharp.github.io/uwotlite/reference/simplicial_set_union.md)
  : Merge Similarity Graph by Simplicial Set Union
- [`tumap()`](https://rmsharp.github.io/uwotlite/reference/tumap.md) :
  Dimensionality Reduction Using t-Distributed UMAP (t-UMAP)
- [`umap()`](https://rmsharp.github.io/uwotlite/reference/umap.md) :
  Dimensionality Reduction with UMAP
- [`umap2()`](https://rmsharp.github.io/uwotlite/reference/umap2.md) :
  Dimensionality Reduction with UMAP
